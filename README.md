...
`RESEND_FROM` defaults to `Job Hunter <onboarding@resend.dev>`. Until you verify a
...
All state lives in one file-backed LibSQL database at `./data/job-hunter.db`
